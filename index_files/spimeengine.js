...
SpimeEngine.demoProduct = function(){
	...
	var demoProductText = "DEMO PRODUCT <br> (to add a real one click the 'sell this product' option in the left click menu)"
	...
	if (SpimeEngine.ecommerceSolution == "IMOS"){
		...
		if (productType == "PHYSICAL"){
			...
			if (shippingCost){
				...
				var currencyArr = {"USD":"$","EUR":"\u20ac","GBP":"\u00a3","BRL":"R$", "JPY":"\u00a5","NZD":"NZ$","SEK":"Kr","CHF":"CHF","NOK":"kr","MYR":"RM","SGD":"S$","AED":"\u062F.\u0625","PKR":"₨"};
